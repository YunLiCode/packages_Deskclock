...
public class Index extends ActivityGroup {
	...
	void InItView() {
		...
		View view00 = getLocalActivityManager().startActivity(
				"activity00",
				new Intent(this,
						com.android.deskclock.AlarmClock.class))
				.getDecorView();

		View view01 = getLocalActivityManager().startActivity("activity01",
				new Intent(this, com.android.deskclock.jishiqi.Timer.class))
				.getDecorView();
		View view02 = getLocalActivityManager().startActivity("activity02",
				new Intent(this, com.android.deskclock.jishiqi.DuociTimer.class))
				.getDecorView();
		View view03 = getLocalActivityManager().startActivity("activity03",
				new Intent(this, com.android.deskclock.jishiqi.MainActivity.class))
				.getDecorView();
